...
var English = map[string]interface{}{
	...
	"errors": map[string]interface{}{
		...
		"bannedUser":                   "Your account is banned and cannot perform this operation.",
		"unapprovedCorporation":        "Vendor approval is required to access this resource.",
		"noPropertyAccess":             "You do not have access to the {0}.",
		...
		"contactSalesSubmissionFailed": "Failed to submit contact sales request.",
		"contactSalesListFailed":       "Failed to list contact sales requests.",
		"contactSalesMarkReadFailed":   "Failed to mark contact sales request as read.",
		"contactSalesDeleteFailed":     "Failed to delete contact sales request.",
		"invalidId":                    "Invalid ID provided.",
		"apiKeyActiveExists":           "An active API key already exists for this profile.",
		"apiKeyProfileNotFound":        "Profile ID not found.",
		"apiKeyRevoked":                "This API key has been revoked.",
		"apiKeyInvalidFormat":          "Invalid API key format.",
		"apiKeyAuthFailed":             "Authentication failed.",
	},
	...
	"ERR_FAILED_TO_SAVE":     "Failed to save resource.",
	"ERR_FAILED_TO_LIST":     "Failed to list resources.",
	"ERR_FAILED_TO_UPDATE":   "Failed to update resource.",
	"ERR_FAILED_TO_DELETE":   "Failed to delete resource.",
	...
	"successMessage": map[string]interface{}{
		...
		"contactSalesSubmitted":      "Contact sales request submitted successfully.",
		"contactSalesMarkedRead":     "Contact sales request marked as read.",
		"contactSalesDeleted":        "Contact sales request deleted successfully.",
	},
	"workflow": map[string]interface{}{
		"status": map[string]interface{}{
			"initialized":            "initialized",
			"ocr_pending_acceptance": "OCR result pending acceptance",
		},
		"next_step": map[string]interface{}{
			"upload_image_ocr":  "upload image for OCR",
			"accept_ocr_result": "accept OCR result",
		},
	},
}
