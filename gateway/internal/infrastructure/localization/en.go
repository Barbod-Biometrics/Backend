...
var English = map[string]interface{}{
	...
	"validation": map[string]interface{}{
		"missing_photo":              "Please provide a 'photo' file",
		"missing_video":              "Please provide a 'video' file",
		"missing_image":              "Please provide an 'image' file",
		"invalid_profile_id":         "Invalid profile ID",
		"invalid_ticket_id":          "Invalid ticket ID",
		"invalid_file_extension":     "file_extension is required",
	...
	"successMessage": map[string]interface{}{
		...
		"profileApproved":            "Profile approved successfully",
		"profileRejected":            "Profile rejected successfully",
		"profileDeleted":             "Profile deleted successfully",
		"ticketsFetched":             "Tickets fetched successfully",
		"walletSummaryFetched":       "Wallet summary fetched successfully",
		"transactionsFetched":        "Transactions fetched successfully",
		"depositSuccessful":          "Deposit completed successfully",
		"profileUpdatedSuccess":      "Profile updated successfully",
	},
	"apikey": map[string]interface{}{
		"activeKeyExists":  "Active API key already exists for this profile ID",
		"useRegenerate":    "Use /regenerate to replace your key.",
