...
func (_c *MockLogger_Close_Call) Return() *MockLogger_Close_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockLogger_Close_Call) RunAndReturn(run func()) *MockLogger_Close_Call {
	_c.Run(run)
	return _c
}
...
func (_mock *MockLogger) Fatal(msg string, fields ...logger.Field) {
	if len(fields) > 0 {
		_mock.Called(msg, fields)
	} else {
		_mock.Called(msg)
...
func (_c *MockLogger_Fatal_Call) Run(run func(msg string, fields ...logger.Field)) *MockLogger_Fatal_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *MockLogger_Fatal_Call) RunAndReturn(run func(msg string, fields ...logger.Field)) *MockLogger_Fatal_Call {
	_c.Run(run)
	return _c
}
